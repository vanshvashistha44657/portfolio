...
1. Push this project to the repository named `YOUR-USERNAME.github.io` so it is served from the domain root.
2. In your GitHub repository, go to **Settings → Pages** and set **Source** to **GitHub Actions**.
3. Push to `main`. The included workflow at `.github/workflows/deploy.yml` builds both `index.html` and `music.html`, then deploys them automatically.
4. Your site will be live at:
   ```
   https://YOUR-GITHUB-USERNAME.github.io/
   https://YOUR-GITHUB-USERNAME.github.io/music.html
   ```
